...
std::vector<HumanPose> groupPeaksToPoses(const std::vector<std::vector<Peak>>& allPeaks,
    ...
    static const std::pair<int, int> limbIdsHeatmap[] = {
        {2, 9}, {2, 3}, {2, 6}, {3, 4}, {4, 5}, {6, 7}, {7, 8}, {9, 10}, {10, 11}, {11, 12}, 
        {9, 13}, {13, 14}, {14, 15}, {2, 1}, {1, 16}, {16, 18}, {1, 17}, {17, 19}, {3, 18}, {6, 19}, 
        {15, 20}, {20, 21}, {15, 22}, {12, 23}, {23, 24}, {12, 25}
    };
    static const std::pair<int, int> limbIdsPaf[] =
    {
        {26, 27}, {40, 41}, {48, 49}, {42, 43}, {44, 45}, {50, 51}, {52, 53}, {32, 33}, {28, 29}, {30, 31},
        {34, 35}, {36, 37}, {38, 39}, {56, 57}, {58, 59}, {62, 63}, {60, 61}, {64, 65}, {46, 47}, {54, 55},
    ...
    for (size_t k = 0; k < arraySize(limbIdsPaf); k++) {
        ...
        bool extraJointConnections = (k == 24 || k == 25);
        if (k == 0) {
